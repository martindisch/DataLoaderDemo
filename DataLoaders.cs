...
{
    [DataLoader]
    public static async Task<IReadOnlyDictionary<int, Author>> GetAuthorsByIdAsync(
        IReadOnlyList<int> authorIds,
        [Service] Database database,
        [Service] ILogger<Author> logger)
    {
    ...
    [DataLoader]
    public static async Task<ILookup<int, Book>> GetBooksByAuthorIdAsync(
        IReadOnlyList<int> authorIds,
        [Service] Database database,
        [Service] ILogger<Book> logger)
    {
